              ...
              <table class="table table-bordered mr-2 ml-2" id="tabel1">
                ...
                <tbody id="tbody2">
                    <tr>
                      ...
                      <td contenteditable="false" class="merk" ><input type="text" name="merk" readonly /></td>
    ...
    $(document).ready(function() {
      ...
      $(document).on('click', '#tambah', function (){
        ...
        var html = "<tr id='baris'"+baris+">"
            html+= "<td>"+baris+"</td>"
            html+= "<td class='product'><select id='product' name='product_id' class='form-control select2bs4' style='width: 100%;'> @foreach ($products as $product) <option :selected='transaction_detail.product_id == {{ $product->id }}' data-merk='{{ $product->merk }}' value='{{ $product->id }}'>{{ $product->name }}</option> @endforeach`</td>"
            html+= "<td contenteditable='false' class='merk'><input type='text'  name='merk' readonly /></td>"
