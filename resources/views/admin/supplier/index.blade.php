...
<div id="controller">
    <div class="container">
      <div class="card">
        <div class="card-header">
          <a href="#" @click="addData()" class="btn btn-sm btn-primary pull-right">Add New Supplier</a> 
        </div>
          ...
          <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="telp" class="form-control" placeholder="Enter Phone Number" :value="data.telp" required="">
              </div>
              <div class="form-group">
                <label>Email</label>
  ...
  <script type="text/javascript">
    ...
    var columns = [
      ...
      {data: 'telp', class: 'text-center', orderable: false},
